...
namespace FFmpegOut
{
    ...
    public class CameraCaptureEditor : Editor
    {
        ...
        SerializedProperty autoExport;
        SerializedProperty filename;
        SerializedProperty exportFolder;
        ...
        void OnEnable()
        {
            ...
            autoExport = serializedObject.FindProperty("autoExport");
            filename = serializedObject.FindProperty("filename");
            exportFolder = serializedObject.FindProperty("exportFolder");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(exportFolder);

            EditorGUILayout.Space();
            EditorGUILayout.PropertyField(autoExport);
