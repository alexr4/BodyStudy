...
namespace FFmpegOut
{
    ...
    public sealed class CameraCapture : MonoBehaviour
    {
        ...
        [SerializeField] public bool autoExport = false;
        [SerializeField] public string filename;
        [SerializeField] public string exportFolder;
        ...
        public static CameraCapture Instance { get; private set; }
        void Awake()
        {
        ...
        public void StartRecording(){
            ...
            if (_session == null)
            {
                ...
                if (camera.targetTexture == null)
                {
                    ...
                    _tempRT.antiAliasing = 1;//GetAntiAliasingLevel(camera);
