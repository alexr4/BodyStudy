...
void vertex(inout appdata_full v, out Input o){
    ...
    float furlength         = _FurLength * o.data.z;
    ...
    v.vertex.xyz            += normalize(direction + vel + noiseDirection) * furlength * FUR_MULTIPLIER;
}
...
void surf(Input IN, inout SurfaceOutputStandard o){
    ...
    o.Alpha     = (mask * viewDirBlend) * maskBase * IN.color.a;
