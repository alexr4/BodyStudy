...
void surf(Input IN, inout SurfaceOutputStandard o){
    ...
    fixed4 ramp  = tex2D(_Ramp, noiseGrey);
    ...
    o.Albedo        = ramp;//lerp(rgba * IN.color.rgb, ramp, smoothstep(0.2, 0.4, 1.0- noiseGrey));// * ((1.0 - FUR_MULTIPLIER) * 0.5 + 0.5);
    ...
    o.Emission      += light * smoothstep(0.45, 0.55, 1.0- noiseGrey);
