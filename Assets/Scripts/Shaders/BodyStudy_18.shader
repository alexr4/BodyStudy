Shader "BonjourLab/BodyStudy_18"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "Assets/Scripts/Vertex/VertexPhysicsBlend.hlsl"
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float4 ramp     = tex2D(_RampLight, float2(IN.pos.w, 0.5));
            ...
            o.Albedo        = lerp(argb * IN.color.rgb, ramp.rgb, lightOn);
            o.Normal        = lerp(anormal, float3(0, 0, 1), lightOn);
            o.Metallic      = lerp(_Metallic, 1.0, lightOn);
            o.Smoothness    = lerp(arough.r, 1.0, lightOn);// * _Glossiness;
