Shader "BonjourLab/BodyStudy_23"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "Assets/Scripts/Vertex/VertexPhysicsBlend-2.hlsl"
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float2 uv           = float2(IN.pos.w, 0.5);
            fixed4 ramp         = tex2D(_AlbedoRamp, uv);


            // Metallic and smoothness come from slider variables
            o.Albedo        = ramp * IN.color.rgb * argb.rgb * occ;
            o.Normal        = anormal;
