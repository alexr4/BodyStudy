Shader "BonjourLab/BodyStudy_14"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #pragma surface frag NoLighting Standard fullforwardshadows vertex:vertex
        ...
        #include "Assets/Scripts/Vertex/FurVertexExtended-3.hlsl"
        ENDCG
