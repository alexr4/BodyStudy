...
{
    public class BodyStudy30 : GPUMeshController
    {
        ...
        public override void SetBasedInstanceData(){
            ...
            for(int i=0; i<maxInstance; i++){
                ...
                props.vel               = new Vector4(normal.x, normal.y, normal.z, 0);
                props.acc               = new Vector4(0, 0, 0, 0);
                props.data              = new Vector4(index, 0, 0, 0); //x → index, y → Free, z → Free, w → Free
